...
class DjangoFeatureSource(QgsAbstractFeatureSource):
    ...
    def __init__(self, model, qgs_fields, dj_fields, dj_geo_field, crs, is_valid):
    ...
    def getFeatures(self, request):
        ...
        self.iterator = QgsFeatureIterator(DjangoFeatureIterator(self, request, self.is_valid))
